...
<section class="no-results not-found">
	<header class="page-header">
		<h1 class="page-title"><?php esc_html_e( 'Nothing Found', 'frenchpress' ); ?></h1>
	</header><!-- .page-header -->
	...
	<div class="page-content">
		...
		<?php else : ?>
			...
			<p><?php esc_html_e( 'It seems we can&rsquo;t find what you&rsquo;re looking for. Perhaps searching can help.', 'frenchpress' ); ?></p>
			<?php get_search_form(); ?>
